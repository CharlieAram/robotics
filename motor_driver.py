...
class MotorDriver:
    ...
    def read_sensor(self):
        try:
            return (self.BP.get_sensor(self.sensor)) #10 is offset to account for the fact that the sensor is not at the center of the robot. idek chief if 10 is accurate
